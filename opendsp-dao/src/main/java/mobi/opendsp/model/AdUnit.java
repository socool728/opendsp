...
public class AdUnit {
    ...
    public void setDeliverTimes(Long deliverTimes) {
    ...
    public String getTargetOsv() {
        return targetOsv;
    }

    public void setTargetOsv(String targetOsv) {
        this.targetOsv = targetOsv;
    }

    public Integer getTargetIncome() {
        return targetIncome;
    }

    public void setTargetIncome(Integer targetIncome) {
